...
class StudentCollectionHttpServer extends Object implements StudentCollection{

   public Hashtable<String,Student> students;
   private static final boolean debugOn = false;
   private static final String studentJsonFileName = "students.json";

   public StudentCollectionHttpServer() {
   ...
   public static void main(String[] args) throws IOException {
      ...
      HttpServer serv = new HttpServer(
         new StudentCollectionHttpServer(),Integer.parseInt(port));
      serv.start();
   }
